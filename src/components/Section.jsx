...
const Section = () => {
  return (
    <div className="border-t  border-gray-900 pt-24 pb-24 flex justify-center">
      <a href="#" className="group relative block w-96 sm:h-80 lg:h-96">
        ...
        <div className="relative flex h-full items-center justify-center border-2 border-gray-200 bg-[#111111] transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
          ...
          <div className="absolute flex items-center justify-center p-4 text-white opacity-0 transition-opacity group-hover:opacity-100 sm:p-6 lg:p-8">
            <div className="text-center">
              ...
              <div className="mt-10 font-bold text-gray-600 hover:text-white">Take me there!</div>
            </div>
          </div>
