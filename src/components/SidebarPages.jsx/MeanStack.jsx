...
const MeanStack = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">MEAN Stack</h1>
      <p className="mb-4 text-sm">
        This boilerplate provides a robust setup for building web applications using the MEAN stack (MongoDB, Express, Angular, Node.js). It's ideal for developers who want to create full-stack applications efficiently.
      </p>
      ...
      <ul className="list-disc ml-5 text-sm">
        ...
        <li className="mb-1">Angular for a powerful frontend framework</li>
