...
const FlaskWithSql = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Flask with SQL</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up a Flask application with an SQL database integration, making it easy to build web applications with a robust backend.
      </p>
      ...
      <ol className="list-decimal ml-5 mb-4 text-sm">
        ...
        <li className="mb-1">
          Apply migrations or initialize the database:{" "}
          <code className="bg-gray-800 p-0.5 text-xs rounded-md">
      ...
      <ul className="list-disc ml-5 text-sm">
        <li className="mb-1">Basic Flask project structure</li>
        <li className="mb-1">SQL database integration using SQLAlchemy</li>
        <li className="mb-1">Pre-configured routes and models</li>
        <li className="mb-1">Sample migration files for database setup</li>
        <li className="mb-1">
