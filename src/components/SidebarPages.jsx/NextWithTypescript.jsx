...
const NextWithTypescript = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Next.js with TypeScript</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up a Next.js project integrated with TypeScript, providing a strong typing system for building scalable and maintainable web applications.
      </p>
      ...
      <a
        href="https://github.com/yashmandi/next-with-typescript"
        target="_blank"
      ...
      <ul className="list-disc ml-5 text-sm">
        <li className="mb-1">Basic project structure with TypeScript</li>
        <li className="mb-1">Essential configurations and scripts</li>
        <li className="mb-1">Pre-configured ESLint and Prettier setup</li>
        <li className="mb-1">Sample components and TypeScript interfaces for quick start</li>
        <li className="mb-1">
...
export default NextWithTypescript;