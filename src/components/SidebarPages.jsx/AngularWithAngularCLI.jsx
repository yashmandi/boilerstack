  ...
  return (
    <div className="pl-4 text-white pr-64">
      ...
      <p className="mb-4 text-sm">
        This boilerplate includes a basic setup with all the necessary configurations of Angular and Angular CLI to get you started with an Angular project.
      </p>
...
export default AngularWithAngularCLI;