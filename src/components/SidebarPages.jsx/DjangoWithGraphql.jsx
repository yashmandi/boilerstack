...
const DjangoWithGraphql = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Django with GraphQL</h1>
      <p className="mb-4 text-sm">
        This boilerplate integrates Django with GraphQL using the Graphene library, providing a robust backend solution for building GraphQL APIs.
      </p>
      ...
      <ul className="list-disc ml-5 text-sm">
        <li className="mb-1">Basic project structure with Django and Graphene for GraphQL</li>
        <li className="mb-1">Essential configurations for GraphQL API development</li>
        <li className="mb-1">Pre-configured settings for GraphQL queries and mutations</li>
        <li className="mb-1">Sample models and schema to get started quickly</li>
        <li className="mb-1">
...
export default DjangoWithGraphql;