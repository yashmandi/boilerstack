...
const DjangoWithRest = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Django with Django REST Framework</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up a Django project integrated with Django REST Framework, providing a powerful backend solution for building RESTful APIs.
      </p>
      ...
      <ul className="list-disc ml-5 text-sm">
        <li className="mb-1">Basic project structure with Django and Django REST Framework</li>
        <li className="mb-1">Essential configurations for RESTful API development</li>
        <li className="mb-1">Pre-configured settings for authentication and permissions</li>
        <li className="mb-1">Sample models and serializers to get started quickly</li>
        <li className="mb-1">
