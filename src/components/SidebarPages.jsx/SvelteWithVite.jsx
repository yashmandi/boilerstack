...
const SvelteWithVite = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Svelte with Vite</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up a Svelte project using Vite, offering a fast and modern development setup with everything you need to start building Svelte applications.
      </p>
      ...
      <a
        href="https://github.com/yashmandi/svelte-with-vite"
        target="_blank"
