...
const Koa = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Koa.js Boilerplate</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up a basic Koa.js server, providing a minimalist yet powerful foundation for building web applications with Koa.js.
      </p>
      ...
      <a
        href="https://github.com/yashmandi/koa-boilerplate"
        target="_blank"
      ...
      <ul className="list-disc ml-5 text-sm">
        ...
        <li className="mb-1">Pre-configured ESLint setup</li>
        <li className="mb-1">Sample routes and middleware</li>
        <li className="mb-1">
