...
const ExpressWithTypescript = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Express.js with TypeScript</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up an Express.js server with TypeScript integration, providing a strong foundation for building scalable and type-safe APIs.
      </p>
      ...
      <a
        href="https://github.com/yashmandi/express-with-typescript"
        target="_blank"
      ...
      <ul className="list-disc ml-5 text-sm">
        <li className="mb-1">TypeScript configuration and setup</li>
        <li className="mb-1">Basic Express.js project structure</li>
        <li className="mb-1">Essential configurations and scripts</li>
        <li className="mb-1">Pre-configured ESLint and Prettier setup</li>
        <li className="mb-1">Sample routes and controllers in TypeScript</li>
        <li className="mb-1">
...
export default ExpressWithTypescript;