...
const NextWithTailwind = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Next.js with Tailwind CSS</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up a Next.js project integrated with Tailwind CSS, providing a seamless development environment for building modern web applications with responsive and utility-first styling.
      </p>
      ...
      <a
        href="https://github.com/yashmandi/next-with-tailwind"
        target="_blank"
...
export default NextWithTailwind;
