...
const Sveltekit = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">SvelteKit</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up a SvelteKit project, providing a powerful and flexible development environment for building modern web applications with SvelteKit.
      </p>
      ...
      <a
        href="https://github.com/yashmandi/sveltekit"
        target="_blank"
