...
const ExpressWithMongo = () => {
  return (
    <div className="pl-6 text-white pr-64">
      <h1 className="text-2xl font-bold mb-4">Express.js with MongoDB</h1>
      <p className="mb-4 text-sm">
        This boilerplate sets up an Express.js server with MongoDB integration, providing a solid foundation for building RESTful APIs with a NoSQL database.
      </p>
      ...
      <a
        href="https://github.com/yashmandi/express-with-mongo"
        target="_blank"
      ...
      <ul className="list-disc ml-5 text-sm">
        <li className="mb-1">Basic project structure with Express.js</li>
        <li className="mb-1">MongoDB connection setup</li>
        <li className="mb-1">Essential configurations and scripts</li>
        <li className="mb-1">Pre-configured ESLint and Prettier setup</li>
        <li className="mb-1">Sample routes and controllers for quick start</li>
        <li className="mb-1">
...
export default ExpressWithMongo;