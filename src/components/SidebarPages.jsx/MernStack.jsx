...
const MernStack = () => {
  return (
    <div className="px-6 md:pr-64">
      <h1 className="text-white font-bold text-2xl">MERN Stack Boilerplate</h1>
      <div className="text-white mt-8 text-sm">
        <p>
          This boilerplate sets up a comprehensive MERN (MongoDB, Express, React, Node) stack project, providing a robust foundation for full-stack development.
        </p>
        <br />
        <p>
          With pre-configured MongoDB, Express server, React frontend, and Node backend, this boilerplate streamlines your development process and allows you to focus on building features rather than setting up the environment.
        </p>
        <br />

        <h2 className="text-xl font-bold mt-8">Getting Access to the Boilerplate</h2>
        ...
        <ul className="list-disc ml-5 text-sm">
          <li className="mb-1">Pre-configured MongoDB, Express, React, and Node setup</li>
          <li className="mb-1">Basic project structure with essential configurations</li>
          <li className="mb-1">Sample code for quick start and easy customization</li>
          <li className="mb-1">Essential dependencies pre-installed (for the ZIP option)</li>
        </ul>
        <div className="mt-4">
          <a
            href="https://github.com/your-repo-link/releases/download/v1.0.0/project-bundle.zip"
