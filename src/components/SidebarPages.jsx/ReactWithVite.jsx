  ...
  return (
    <div className="pl-4 text-white pr-64">
      ...
      <p className="mb-4 text-sm">
        This boilerplate provides a setup using Vite for building React applications, offering a fast and efficient development environment with instant module reloading.
      </p>
